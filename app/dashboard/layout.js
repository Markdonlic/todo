  ...
  return (
    <div className="w-full">
      ...
      <div className="flex min-h-screen w-full">
        <div className={`${openArch ? "translate-x-0 sm:w-[218px]" : "-translate-x-[218px] sm:translate-x-0 sm:w-[218px]"} z-30 transition-all ease-in-out duration-500 sticky top-[5rem] h-full`}>
