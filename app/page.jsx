      ...
      <div className="w-full flex flex-col gap-8">
        <div className="w-full flex lg:justify-end">
          <p className="text-neutral-600 font-semibold capitalize">
            new user?{" "}
            <span className="text-sky-500 hover:underline hover:underline-offset-4 hover:text-neutral-800 transition-all duration-500">
              <Link href="#">Sign Up</Link>
            </span>
          </p>
        </div>
        <div className="text-center text-xl font-semibold uppercase">Login</div>
